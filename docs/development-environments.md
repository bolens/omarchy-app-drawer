...
Apple execution is not verified by Linux tests. Quickshell, Wayland, and stock-bar integration require a supported Linux/Omarchy host. Successful container validation does not establish those capabilities.
