...
Item {
    ...
    Component {
      ...
      Item {
        ...
        Row {
          ...
          Item {
            width: root.widgetDrawerExpanded ? hiddenRightModules.implicitWidth : 0
            height: hiddenRightModules.implicitHeight
            clip: true
    ...
    Component {
      ...
      Item {
        ...
        Column {
          ...
          Item {
            width: hiddenVerticalRightModules.implicitWidth
            height: root.widgetDrawerExpanded ? hiddenVerticalRightModules.implicitHeight : 0
            clip: true
  ...
  component WidgetDrawerToggle: WidgetButton {
    ...
    tooltipText: root.widgetDrawerExpanded ? "Hide bar widgets" : "Show bar widgets"
    active: root.widgetDrawerExpanded
